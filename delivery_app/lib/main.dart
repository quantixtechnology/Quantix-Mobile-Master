...
class QuantixDeliveryApp extends ConsumerStatefulWidget {
  const QuantixDeliveryApp({super.key});

  @override
  ConsumerState<QuantixDeliveryApp> createState() => _QuantixDeliveryAppState();
}

class _QuantixDeliveryAppState extends ConsumerState<QuantixDeliveryApp> {
  @override
  void initState() {
    super.initState();
    _initFcm();
  ...
  Future<void> _initFcm() async {
    ...
    ref.listenManual<AuthState>(deliveryAuthProvider, (prev, next) async {
